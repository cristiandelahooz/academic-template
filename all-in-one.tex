% =============================================================================
% TEMPLATE ACADÉMICO PARA TRABAJOS EDUCATIVOS - VERSIÓN AUTOCONTENIDA
% =============================================================================
...
% 4. Ejecutar: pdflatex + biber + pdflatex + pdflatex
%
% COMPATIBILIDAD LLM:
...
% Información del logo institucional (comentado para versión autocontenida, si el logo no fue proporcionado, solicitar el mismo)
\newcommand{\institutionalLogo}{assets/Logo PUCMM (Color).png}
...
% =============================================================================
% DEFINICIÓN DE PÁGINA DE TÍTULO (INTEGRADA)
% =============================================================================
% Comando que genera la página de título profesional
...
\newcommand{\createTitlePage}{
    \begin{titlepage}
        ...
        \begin{center}
            ...
            % Logo institucional (comentado para versión autocontenida)
